...
export default defineConfig({
  ...
  test: {
    exclude: [
      ...
      'apps/web/src/app/api/v1/agent-personas/[id]/route.test.ts',
      'apps/web/src/app/api/v1/agent-personas/route.test.ts',
      'apps/web/src/app/api/v1/agent-routing-rules/route.test.ts',
      'apps/web/src/app/api/v1/agent-runs/[id]/retry/route.test.ts',
      'apps/web/src/app/api/v1/agent-runs/[id]/route.test.ts',
      'apps/web/src/app/api/v1/agent-runs/route.test.ts',
      'apps/web/src/app/api/v1/agent-sessions/[id]/route.test.ts',
      'apps/web/src/app/api/v1/agent-sessions/route.test.ts',
