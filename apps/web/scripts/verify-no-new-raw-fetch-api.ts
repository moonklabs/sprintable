...
// story #2691(2026-08-17) 착수 시점 잔존 채무 스냅샷 — #2689(8곳)+#2691(130곳) 전환 이후에도
// 여전히 raw fetch인 mutation/handler/pre-auth류. 새로 늘어나는 것만 막고 이 목록은 개별
// triage(별도 스토리)로 넘긴다. 파일 경로+URL 고정 접두사 조합이 키 — 라인 번호 아님(코드
// 변경에 안 흔들림).
export const GRANDFATHER_BASELINE = new Set<string>([
  'app/(authenticated)/[ws]/[proj]/docs/[slug]/page.tsx::/api/docs?project_id=',
  ...
  'app/(authenticated)/[ws]/[proj]/docs/docs-shell-client.tsx::/api/docs?project_id=',
  'app/(authenticated)/[ws]/[proj]/docs/docs-shell-client.tsx::/api/docs',
  'app/(authenticated)/[ws]/[proj]/docs/docs-shell-client.tsx::/api/docs/',
  ...
  'app/(authenticated)/[ws]/[proj]/loops/[id]/loop-detail-client.tsx::/api/docs/',
  'app/(authenticated)/[ws]/[proj]/loops/[id]/loop-detail-client.tsx::/api/hypotheses/',
  'app/(authenticated)/[ws]/[proj]/loops/[id]/loop-detail-client.tsx::/api/loops/',
  'app/(authenticated)/[ws]/[proj]/loops/[id]/loop-detail-client.tsx::/api/me',
  'app/(authenticated)/[ws]/[proj]/loops/loops-client.tsx::/api/loops?',
  'app/(authenticated)/[ws]/[proj]/retro/[id]/page.tsx::/api/retro-sessions/',
  'app/(authenticated)/[ws]/[proj]/retro/page.tsx::/api/retro-sessions',
  'app/(authenticated)/[ws]/[proj]/sprints/sprints-client.tsx::/api/sprints?project_id=',
  ...
  'app/(authenticated)/chats/[conversation_id]/page.tsx::/api/conversations/',
  'app/(authenticated)/chats/[conversation_id]/page.tsx::/api/team-members?type=agent',
  'app/(authenticated)/gates/[id]/page.tsx::/api/gates/',
  ...
  'app/(authenticated)/organization/workforce/[id]/page.tsx::/api/agents/',
  'app/(authenticated)/organization/workforce/[id]/page.tsx::/api/me',
  'app/(authenticated)/organization/workforce/[id]/page.tsx::/api/projects',
  'app/(authenticated)/organization/workforce/[id]/page.tsx::/api/team-members/',
  'app/(authenticated)/organization/workforce/[id]/page.tsx::/api/webhooks/config?id=',
  'app/(authenticated)/organization/workforce/[id]/page.tsx::/api/webhooks/config?project_id=',
  ...
  'app/(authenticated)/organization/workforce/recruiter/recruiter-client.tsx::/api/role-templates?locale=',
  'app/(authenticated)/organization/workforce/recruiter/recruiter-client.tsx::/api/runtime-capabilities',
  ...
  'app/(authenticated)/settings/page.tsx::/api/organizations/',
  'app/(authenticated)/settings/page.tsx::/api/projects',
  'app/(authenticated)/settings/page.tsx::/api/projects/',
  'app/(authenticated)/settings/page.tsx::/api/subscription/portal',
  'app/(authenticated)/settings/page.tsx::/api/subscription/status',
  'app/(authenticated)/settings/page.tsx::/api/team-members?project_id=',
  ...
  'app/onboarding/connect-step.tsx::/api/agents/',
  ...
  'app/onboarding/verify-rail.tsx::/api/agents/',
  'components/activity/activity-log-view.tsx::/api/activity-logs?',
  'components/activity/dashboard-activity-timeline.tsx::/api/activity-logs?project_id=',
  'components/activity/team-activity-view.tsx::/api/activity-stream?',
  'components/agents/access-matrix-tab.tsx::/api/agents/access-matrix',
  'components/agents/access-matrix-tab.tsx::/api/projects',
  'components/agents/access-matrix-tab.tsx::/api/projects/',
  'components/agents/access-matrix-tab.tsx::/api/team-members?type=agent&include_inactive=true',
  'components/agents/agent-api-key-manager.tsx::/api/agents/',
  'components/agents/agent-management-tab.tsx::/api/projects/',
  'components/agents/agent-management-tab.tsx::/api/team-members?type=agent&include_inactive=true',
  'components/agents/agent-management-tab.tsx::/api/team-members/',
  'components/agents/agent-performance-panel.tsx::/api/analytics/agent-stats?project_id=',
  'components/agents/agent-performance-panel.tsx::/api/analytics/velocity-history?project_id=',
  'components/agents/agent-performance-panel.tsx::/api/rewards/leaderboard?project_id=',
  'components/agents/agent-performance-panel.tsx::/api/team-members?project_id=',
  'components/agents/agent-run-detail.tsx::/api/v1/agent-runs/',
  'components/agents/agent-runs-list.tsx::/api/v1/agent-runs?',
  'components/agents/messaging-policy-section.tsx::/api/agents/',
  'components/agents/messaging-policy-section.tsx::/api/org-members',
  'components/attention-queue/attention-queue-view.tsx::/api/glance/attention?project_id=',
  'components/cage/gate-undo-button.tsx::/api/gates/',
  'components/cage/stuck-handoff-section.tsx::/api/stories/',
  'components/canvas/artifact-section.tsx::/api/gates?work_item_id=',
  ...
  'components/chat/approval-request-card.tsx::/api/gates/',
  'components/chat/attachment-file.tsx::/api/attachments/sign?',
  'components/chat/attachment-image.tsx::/api/attachments/sign?',
  'components/chat/attachment-media.tsx::/api/attachments/sign?',
  'components/chat/chat-list-view.tsx::/api/conversations?project_id=',
  'components/chat/chat-list-view.tsx::/api/conversations/recent-outside-project?project_id=',
  'components/chat/chat-view.tsx::/api/conversations/',
  ...
  'components/chat/image-lightbox.tsx::/api/attachments/sign?',
  ...
  'components/chat/thread-panel.tsx::/api/conversations/',
  'components/dashboard/command-center/command-center.tsx::/api/dashboard/my-actions',
  'components/dashboard/command-center/command-center.tsx::/api/dashboard/overview',
  'components/dashboard/command-center/command-center.tsx::/api/team-members',
  'components/dispatch/entity-dispatch-panel.tsx::/api/dispatch',
  'components/docs/doc-content-renderer.tsx::/api/attachments/sign?asset_id=',
  'components/docs/doc-gate-section.tsx::/api/docs/',
  'components/docs/doc-gate-section.tsx::/api/gates?work_item_id=',
  'components/docs/doc-gate-section.tsx::/api/gates/',
  'components/docs/doc-gate-section.tsx::/api/team-members',
  'components/docs/doc-share-dialog.tsx::/api/docs/',
  'components/docs/extensions/file-node.tsx::/api/attachments/sign?asset_id=',
  'components/docs/extensions/image-node.tsx::/api/attachments/sign?asset_id=',
  'components/docs/extensions/image-upload.ts::/api/docs/',
  'components/docs/extensions/page-embed-node.tsx::/api/docs/preview?',
  ...
  'components/flow/flow-epic-nodes.tsx::/api/stories/',
  'components/flow/flow-multi-lane-canvas.tsx::/api/analytics/epic-flow-nodes?project_id=',
  'components/flow/flow-multi-lane-canvas.tsx::/api/goals/',
  'components/flow/flow-multi-lane-canvas.tsx::/api/stories?',
  'components/flow/flow-multi-lane-canvas.tsx::/api/stories/',
  'components/flow/flow-node-story-panel.tsx::/api/stories/',
  ...
  'components/flow/hypothesis-earth-layer.tsx::/api/hypotheses?project_id=',
  ...
  'components/flow/unattached-bucket.tsx::/api/stories?project_id=',
  'components/flow/unattached-bucket.tsx::/api/stories/',
  'components/hypotheses/hypotheses-section.tsx::/api/gates?status=pending',
  'components/hypotheses/hypotheses-section.tsx::/api/gates?status=rejected',
  'components/hypotheses/hypotheses-section.tsx::/api/hypotheses?project_id=',
  ...
  'components/hypotheses/hypotheses-section.tsx::/api/team-members',
  'components/hypotheses/hypothesis-gate-badge.tsx::/api/gates/',
  'components/hypotheses/story-hypotheses-section.tsx::/api/gates?status=pending',
  'components/hypotheses/story-hypotheses-section.tsx::/api/gates?status=rejected',
  'components/hypotheses/story-hypotheses-section.tsx::/api/hypotheses?project_id=',
  'components/hypotheses/story-hypotheses-section.tsx::/api/hypotheses/',
  'components/inbox/approvals-queue.tsx::/api/gates/',
  'components/inbox/approvals-queue.tsx::/api/gates/inbox?status=held&sort=urgency&assigned_to_me=true',
  'components/inbox/approvals-queue.tsx::/api/gates/inbox?status=pending&sort=urgency&assigned_to_me=true',
  'components/inbox/approvals-queue.tsx::/api/v1/hitl-requests/',
  'components/inbox/decisions-waiting.tsx::/api/inbox/',
  'components/integrations/pr-link-section.tsx::/api/integrations/github/links?story_id=',
  'components/integrations/pr-link-section.tsx::/api/integrations/github/links',
  'components/integrations/pr-link-section.tsx::/api/integrations/github/links/',
  'components/integrations/pr-link-section.tsx::/api/integrations/github/status',
  'components/kanban/kanban-board.tsx::/api/dependencies/graph?item_type=story',
  'components/kanban/kanban-board.tsx::/api/gates?status=pending&work_item_type=story',
  'components/kanban/kanban-board.tsx::/api/goals?',
  'components/kanban/kanban-board.tsx::/api/item-labels?item_type=story',
  'components/kanban/kanban-board.tsx::/api/labels',
  'components/kanban/kanban-board.tsx::/api/members',
  'components/kanban/kanban-board.tsx::/api/sprints',
  'components/kanban/kanban-board.tsx::/api/stories?',
  'components/kanban/kanban-board.tsx::/api/stories',
  'components/kanban/kanban-board.tsx::/api/stories/',
  'components/kanban/kanban-board.tsx::/api/stories/bulk',
  'components/kanban/kanban-board.tsx::/api/stories/workflow-line/status?ids=',
  'components/kanban/kanban-board.tsx::/api/tasks?story_id=',
  'components/kanban/kanban-board.tsx::/api/workflow-executions/story-summary?',
  ...
  'components/org-briefing/loop-face.tsx::/api/dashboard/overview',
  'components/org-briefing/loop-face.tsx::/api/hypotheses?project_id=',
  'components/org-briefing/workforce-face.tsx::/api/dashboard/overview',
  'components/org-briefing/workforce-face.tsx::/api/stories?epic_id=',
  'components/org-briefing/workforce-face.tsx::/api/team-members',
  'components/settings/add-member-modal.tsx::/api/organizations/',
  'components/settings/agent-project-access-section.tsx::/api/projects/',
  'components/settings/ai-settings.tsx::/api/projects/',
  'components/settings/blocked-users-section.tsx::/api/team-members/',
  'components/settings/blocked-users-section.tsx::/api/user-blocks',
  'components/settings/blocked-users-section.tsx::/api/user-blocks/',
  'components/settings/byom-key-management.tsx::/api/projects/',
  'components/settings/gate-level-matrix.tsx::/api/organizations/',
  'components/settings/gate-level-matrix.tsx::/api/projects/',
  'components/settings/mcp-connection-settings.tsx::/api/projects/',
  ...
  'components/settings/my-notification-channel-section.tsx::/api/webhooks/config/',
  'components/settings/my-profile-section.tsx::/api/me',
  'components/settings/org-members-section.tsx::/api/org-members',
  'components/settings/org-members-section.tsx::/api/org-members/',
  'components/settings/org-members-section.tsx::/api/organizations/',
  'components/settings/org-members-section.tsx::/api/projects',
  'components/settings/project-access-section.tsx::/api/org-members',
  'components/settings/project-access-section.tsx::/api/projects/',
  ...
  'components/settings/workflow-active-line-view.tsx::/api/workflow-line-config/active?',
  'components/settings/workflow-execution-history-section.tsx::/api/workflow-executions?project_id=',
  'components/settings/workflow-line-editor-section.tsx::/api/workflow-line-config/active?',
  ...
  'components/settings/workflow-template-gallery-section.tsx::/api/team-members?project_id=',
  'components/settings/workflow-template-gallery-section.tsx::/api/v1/agent-routing-rules?project_id=',
  ...
  'components/shared/story-origin-section.tsx::/api/stories/',
  ...
  'lib/toolset-catalog.ts::/api/mcp/toolset-catalog',
