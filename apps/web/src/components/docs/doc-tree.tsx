    ...
    <div ref={setNodeRef} style={style}>
      <div className="group relative">
        ...
        >
          ...
          <button onClick={handleDelete} className="w-full rounded-md px-3 py-2 text-left text-sm text-destructive-on-subtle dark:text-destructive hover:bg-destructive/10">Delete</button>
        </div>
      </div>
