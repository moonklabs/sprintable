  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        // story #4210(유나 390 실측) — 닫기(X)가 떠 있으면 제목 줄이 그 자리를 비우도록 표지(아래 DialogTitle).
        ...
        className={cn(
          ...
          // 제 칸에서 스크롤. group/dialog는 DialogTitle이 닫기 버튼 유무를 읽는 데 쓴다.
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        ...
        "font-heading text-base leading-none font-medium group-data-[close-button]/dialog:pr-8",
        className
      )}
      {...props}
    />
