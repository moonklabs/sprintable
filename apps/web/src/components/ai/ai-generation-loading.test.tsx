...
// GenerationSkeleton(내부)이 story #3930으로 common.aiUpcomingDraft/aiUpcomingSynthesis를
// useTranslations로 조회하게 돼 NextIntlClientProvider 없이는 렌더가 throw한다.
