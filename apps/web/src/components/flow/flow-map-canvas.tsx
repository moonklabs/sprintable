  ...
  return (
    <div className="relative overflow-hidden rounded-md border border-border bg-card">
      ...
      {linkDraft.phase === 'error' ? (
        <div role="alert" className="flex items-center justify-between gap-2 border-t border-destructive/30 bg-destructive/10 px-3 py-2 text-[11px] text-destructive-on-subtle dark:text-destructive">
