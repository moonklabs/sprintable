...
export function StuckHandoffDetail({ step }: StuckHandoffDetailProps) {
  ...
  return (
    <div className="space-y-2">
      ...
      {step.delivery_error ? (
        <div className="flex items-start gap-1.5 rounded-md border border-destructive/30 bg-destructive/5 px-2 py-1.5 text-[11px] text-destructive-on-subtle/85 dark:text-destructive/85">
