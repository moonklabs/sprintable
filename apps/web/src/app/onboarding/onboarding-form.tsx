    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className={`w-full ${step === 'connect' ? 'max-w-lg' : 'max-w-md'} space-y-6 rounded-2xl border border-border bg-card p-6 shadow-lg sm:p-8`}>
        ...
        {error && (
          ...
          <div role="alert" aria-live="assertive" aria-atomic="true" className="rounded-lg border border-destructive/20 bg-destructive/10 p-3 text-sm text-destructive-on-subtle dark:text-destructive">
            {error}
          </div>
        )}
