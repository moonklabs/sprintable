    ...
    <div className="flex min-h-screen items-center justify-center bg-muted">
      <div className="w-full max-w-sm space-y-6 rounded-2xl bg-background p-4 shadow-lg sm:p-8">
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          />
          <p className="text-sm text-muted-foreground">AI-powered sprint management</p>
        </div>
        ...
        {process.env.NEXT_PUBLIC_OAUTH_ENABLED === 'true' && (
          <div className="space-y-3">
            ...
            <p className="text-center text-xs text-muted-foreground/60">
              ...
              <a href="/terms" target="_blank" className="underline hover:text-foreground/60">Terms of Service</a>
              {' '}and{' '}
              <a href="/privacy" target="_blank" className="underline hover:text-foreground/60">Privacy Policy</a>
            </p>
          </div>
        )}
