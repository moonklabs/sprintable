...
const PATH = '/api/v2/agent-deployments/preflight';
const okRes = (b: unknown = { ok: 1 }) =>
  new Response(JSON.stringify(b), { status: 200, headers: { 'content-type': 'application/json' } });
const req = () => new Request('http://localhost/x/preflight', { method: 'POST' });

describe('POST /api/v1/agent-deployments/preflight (proxy 위임)', () => {
