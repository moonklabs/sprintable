...
describe('/api/organizations/[id]/api-usage-budget (story #3808 PR3/PR5a — generation-budget/route.ts와 동형)', () => {
  it('GET — FastAPI 잔량 조회 엔드포인트로 id를 그대로 위임', async () => {
    ...
    expect(proxyToFastapiWithParams).toHaveBeenCalledWith(
      request, '/api/v2/organizations/[id]/api-usage-budget', { id: 'org-1' },
    );
  ...
  it('GET — BE 404 응답도 삼키지 않고 그대로 통과시킨다', async () => {
    proxyToFastapiWithParams.mockResolvedValue(
