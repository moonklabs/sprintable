...
_CI_OR_LOCAL_ONLY_ALLOWLIST = frozenset({
    ...
    "collect_ci_shard_durations.py",              # story #4159 — CI/로컬 1회성 재측정 도구
                                                   # (measure_destructive_durations_local.py의
                                                   # CI측 대응물, 동일 범주). gh CLI로 GitHub
                                                   # Actions 아티팩트만 왕복 — 운영 DB 무접속.
