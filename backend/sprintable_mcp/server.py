...
_TOOL_DEFS: list[tuple] = [
    ...
    ("sprintable_list_epics",
     "[DEPRECATED→sprintable_list_goals] 에픽 목록 조회.",
     ListGoalsInput, list_goals),
    ("sprintable_add_epic",
     "[DEPRECATED→sprintable_add_goal] 에픽 생성.",
     AddGoalInput, add_goal),
    ("sprintable_update_epic",
     "[DEPRECATED→sprintable_update_goal] 에픽 수정.",
     UpdateGoalInput, update_goal),
    # Hypotheses (6)
    ...
    ("sprintable_get_epic_progress",
     "[DEPRECATED→sprintable_get_goal_progress] 에픽 진행 현황 조회.",
     GoalProgressInput, get_goal_progress),
