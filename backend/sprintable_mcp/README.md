...
| prod | `scripts/deploy_mcp_prod.sh` | `sprintable-mcp-prod` | `sprintable-mcp-prod-787818285179.asia-northeast3.run.app`(exact·보호 ON) |
...
- **온보딩 config**: prod 백엔드에 `MCP_PUBLIC_URL`(=`https://sprintable-mcp-prod-.../mcp`) 설정 시
