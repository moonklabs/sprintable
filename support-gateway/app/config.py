...
class Settings(BaseSettings):
    ...
    # (feedback_actor_type_failclosed와 동형). 배포 SSOT는 cloudbuild.yaml
    # deploy-support-gateway 스텝(--update-secrets, SUPPORT_GATEWAY_ADMIN_TOKEN_${_DEPLOY_ENV}
    # 참조)+infra/cloudbuild-secret-manifest.txt — 시크릿 실물 프로비저닝은 PO 레인.
    admin_token: str = ""
